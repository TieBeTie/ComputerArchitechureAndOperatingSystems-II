...
void send_ping(char *IPv4, uint64_t interval, uint64_t timeout) {
  ...
  tv_out.tv_usec = 0;
  setsockopt(socket_ping, SOL_SOCKET, SO_RCVTIMEO, (char *) &tv_out, sizeof(tv_out));
