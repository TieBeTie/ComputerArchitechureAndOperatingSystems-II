/*
    ...
    Необходимо выполнить HTTP-GET запрос к серверу
    вывести содержимое файла на стандартный поток вывода.
...
FILE *HTTPGet(int socket_fd, char *server_name, char* path_to_file) {
